...
// Mobile compositions
import HagicodeHeaderMobile, { DURATION_IN_FRAMES as HAGICODE_HEADER_MOBILE_DURATION } from "./compositions/HagicodeHeaderMobile";
import HagicodeReleaseNotesMobile, { calculateDuration as calculateDurationMobile, UpdateBulletinDataSchema as UpdateBulletinDataSchemaMobile } from "./compositions/HagicodeReleaseNotesMobile";
import HagicodeTailMobile from "./compositions/HagicodeTailMobile";
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/* ============================================ */}
      {/* Mobile Compositions (1080x1920 @ 60fps) */}
      {/* ============================================ */}

      {/* Hagicode Header - Mobile */}
      <Composition
        id="HagicodeHeaderMobile"
        component={HagicodeHeaderMobile}
        durationInFrames={HAGICODE_HEADER_MOBILE_DURATION}
        fps={60}
        width={1080}
        height={1920}
        defaultProps={{}}
      ...
      {/* Hagicode Release Notes - Mobile */}
      <Composition
        id="HagicodeReleaseNotesMobile"
        component={HagicodeReleaseNotesMobile}
        durationInFrames={calculateDurationMobile(defaultData)}
        fps={60}
        width={1080}
        height={1920}
        schema={UpdateBulletinDataSchemaMobile}
        defaultProps={defaultData}
      />

      {/* Hagicode Tail - Mobile */}
      <Composition
        id="HagicodeTailMobile"
        component={HagicodeTailMobile}
        durationInFrames={60 * 5} // 5 seconds @ 60fps
        fps={60}
        width={1080}
        height={1920}
